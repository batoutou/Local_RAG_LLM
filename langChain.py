...
class langchain :
    def __init__(self) -> None:
        ...
        # template to determine the querry type between Text, Image and Resume
        self.querry_template = """Based on the following prompt, I just want to know whether the user is expecting a text answer or a generated image or a resume of a given pdf file. 
    ...
    def get_querry_type(self, question):
        ...
        # create a prompt based on the querry template
    ...
    def get_prompt(self, querry_type):
        # pick the adequate querry type and return the corresponding prompt 
        if querry_type == "text":
